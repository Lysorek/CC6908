...
Report bugs at [https://github.com/Lysorek/Ayatori/issues](https://github.com/Lysorek/Ayatori/issues).
W
Stambling upon a Bug means encountering different behaviour than the expected/advertised one. When you are reporting a bug, please include the following infromation by filling in [the template](https://github.com/Lysorek/Ayatori/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
Ayatori could always use more documentation, whether as part of the official Ayatori docs, in docstrings, etc.
...
The best way to send feedback is to file an issue at [https://github.com/Lysorek/Ayatori/issues](https://github.com/Lysorek/Ayatori/issues).
...
Here's how to set up `Ayatori` for local development.

1. Fork the `Ayatori` repo on GitHub.
2. Clone your fork locally:

```bash
git clone git@github.com:Lysorek/Ayatori.git
```
...
Ayatori is designed to do one thing, and do that one thing very well.
...
The roadmap located [here](https://github.com/Lysorek/Ayatori/milestones?direction=desc&sort=due_date&state=open)
